# Ingeniería de software – Repaso de conceptos

Repositorio para repasar conceptos fundamentales de ingeniería de software. Cada tema tiene su propio README con un resumen y enlaces de navegación.

## Temas

### 1. Fundamentos de programación

- [Paradigmas de Programación](temas/paradigmas-programacion/README.md)
- [Programación orientada a objetos (POO)](temas/poo/README.md)
- [Algoritmos de ordenamiento](temas/algoritmos-ordenamiento/README.md)

### 2. Diseño y calidad de código

- [Principios SOLID](temas/solid/README.md)
- [Patrones de Diseño](temas/patrones-diseno/README.md)
- [GoF: patrones de diseño](temas/gof-patrones-diseno/README.md)
- [Clean Code](temas/clean-code/README.md)
- [Atributos de calidad del software](temas/calidad/README.md)
- [Calidad de código en local](temas/calidad-codigo-local/README.md)
- [Complejidad ciclomática y anidada](temas/complejidad-ciclomatica-anidada/README.md)

### 3. Arquitectura y pruebas

- [Arquitectura de Software](temas/arquitectura-de-software/README.md)
- [Pruebas](temas/pruebas/README.md)
- [Pruebas unitarias en Angular, Flutter y Java](temas/pruebas-unitarias-angular-flutter-java/README.md)
- [TDD y BDD](temas/tdd-bdd/README.md)
...
- [JDK, JRE, JVM](temas/jdk-jre-jvm/README.md)
- [Mejoras en Java a medida que sube de versión](temas/mejoras-java-versiones/README.md)
- [Interfaz vs Clase Abstracta](temas/interfaz-vs-clase-abstracta/README.md)
- [Extender vs Implementar](temas/extender-vs-implementar/README.md)
...
- [Angular: conceptos principales](temas/angular-conceptos/README.md)
- [RxJS](temas/rxjs/README.md)
- [SOAP y REST en Angular, Java y Flutter](temas/soap-rest-angular-java-flutter/README.md)

### 8. Móvil / multiplataforma: Flutter
...
- [CI/CD en DevOps](temas/ci-cd-devops/README.md)
- [Jenkins](temas/jenkins/README.md)

### 10. Cloud y servicios

- [Servicios AWS](temas/servicios-aws/README.md)
- [Servicios Azure](temas/servicios-azure/README.md)
- [Servicios Firebase y Google Cloud](temas/servicios-firebase-google/README.md)
- [Red Hat](temas/redhat/README.md)

### 11. Seguridad, rendimiento y observabilidad
